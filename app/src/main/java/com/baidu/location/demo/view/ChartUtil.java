...
import com.baidu.location.demo.view.CustomMarkerView;
...
public class ChartUtil {
    ...
    public static void showChart(Context context, LineChart lineChart, List<String> xDataList,
        ...
        // 设置X轴标签颜色
        xAxis.setTextColor(context.getApplicationContext().getResources().getColor(R.color.white));
        // 轴线
        ...
        yAxis.setTextColor(context.getApplicationContext().getResources().getColor(R.color.white));
    }
     ...
     * @return LineData
     */
    public static LineData setLineData(Context context, List<String> xDataList, List<Entry> yDataList,
                                       String curveLable) {
